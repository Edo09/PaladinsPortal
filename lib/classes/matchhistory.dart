...
//
//     final matchHistory = matchHistoryFromJson(jsonString);

import 'dart:convert';

List<MatchHistory> matchHistoryFromJson(String str) =>
    List<MatchHistory>.from(json.decode(str).map((x) => MatchHistory.fromJson(x)));

String matchHistoryToJson(List<MatchHistory> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
